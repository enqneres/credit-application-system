...
class CreditResource (
    ...
    fun saveCredit(@RequestBody creditDto: CreditDto): ResponseEntity<String>{
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body("Credit ${credit.creditCode} - " +
                "Customer ${credit.customer?.email} saved!")
    }
    ...
    fun findByCreditCode(
        ...
        @PathVariable creditCode: java.util.UUID): ResponseEntity<CreditView> {
